...
- (void)setupGLByGLKit
{
    ...
    glVertexAttribPointer(MCGLPosition, 3, GL_FLOAT, GL_FALSE, 24, BUFFER_OFFSET(0));
    glEnableVertexAttribArray(MCGLNormal);
    glVertexAttribPointer(MCGLNormal, 3, GL_FLOAT, GL_FALSE, 24, BUFFER_OFFSET(12));
...
#ifdef USEMC
    // monkc update
    //call(mainScene, MainScene, moveCameraOneStep, self.timeSinceLastUpdate * 5.0f, self.timeSinceLastUpdate * 1.0f);
